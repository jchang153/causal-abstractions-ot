...
OUT_DIR = ROOT / "results" / "shared_ot_guided_das_h8_multiseed"
CHECKPOINT_MAP = ";".join(
    [
        f"0={ROOT / 'results' / 'checkpoints' / 'gru_h8_seed0.pt'}",
        f"1={ROOT / 'results' / 'checkpoints' / 'gru_h8_seed1.pt'}",
        f"2={ROOT / 'results' / 'checkpoints' / 'gru_h8_seed2.pt'}",
    ]
)
