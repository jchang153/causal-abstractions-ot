...
mapfile -t STAGE_C_JOBS < <(
  ...
  OT_LAMBDAS="${OT_LAMBDAS:-0.5,1,2,4}" STAGE_C_TOP_CONFIGS_PER_VAR="${STAGE_C_TOP_CONFIGS_PER_VAR:-1}" \
  GUIDED_MASK_NAMES="${GUIDED_MASK_NAMES:-Selected}" STAGE_C_DIM_HINT_SCALE_FACTORS="${STAGE_C_DIM_HINT_SCALE_FACTORS:-0.5,0.75,1,1.25,1.5,2}" \
  ENABLE_PCA_SUPPORT_GUIDED_DAS="${ENABLE_PCA_SUPPORT_GUIDED_DAS:-0}" DISABLE_DIM_HINT_DAS="${DISABLE_DIM_HINT_DAS:-0}" \
