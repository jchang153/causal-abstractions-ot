...
echo "[submit-delta-hpar-b] native_block_resolutions=${NATIVE_BLOCK_RESOLUTIONS:-1,8,32,72,144,288,576}"
...
echo "[submit-delta-hpar-b] guided_subspace_dims=${GUIDED_SUBSPACE_DIMS:-width-aware-wide-grid}"
