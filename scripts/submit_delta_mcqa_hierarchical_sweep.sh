...
echo "[submit-delta-hier] stages=${STAGES:-stage_a_layer_ot,stage_b_pca_ot,stage_c_guided_das}"
...
echo "[submit-delta-hier] pca_num_bands_values=${PCA_NUM_BANDS_VALUES:-8}"
