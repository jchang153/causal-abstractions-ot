...
TIMESTAMP="${1:?Usage: bash scripts/aggregate_anvil_mcqa_hierarchical_parallel.sh <timestamp>}"
...
echo "[aggregate-anvil-hpar] summary: ${ROOT}/hierarchical_parallel_summary.txt"
