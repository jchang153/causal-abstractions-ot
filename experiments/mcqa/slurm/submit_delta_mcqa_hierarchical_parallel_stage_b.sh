...
TIMESTAMP="${1:?Usage: bash experiments/mcqa/slurm/submit_delta_mcqa_hierarchical_parallel_stage_b.sh <timestamp>}"
...
echo "[submit-delta-hpar-b] pca_num_bands_values=${PCA_NUM_BANDS_VALUES:-1,2,4,8,16,32,64}"
...
python experiments/mcqa/mcqa_delta_hierarchical_parallel.py plan-stage-b "${COMMON_ARGS[@]}"
