...
TIMESTAMP="${1:?Usage: bash experiments/mcqa/slurm/aggregate_delta_mcqa_hierarchical_parallel.sh <timestamp>}"
...
python experiments/mcqa/mcqa_delta_hierarchical_parallel.py aggregate-final "${COMMON_ARGS[@]}"
