...
echo "[submit-delta-hier] stages=${STAGES:-stage_a_plot_layer,stage_b_plot_native_support,stage_b_plot_pca_support,stage_c_plot_das_layer,stage_c_plot_das_dimension,stage_c_plot_das_pca_support}"
echo "[submit-delta-hier] split_seed=${SPLIT_SEED:-0}"
echo "[submit-delta-hier] plot_alignment_method=${PLOT_ALIGNMENT_METHOD:-ot}"
...
echo "[submit-delta-hier] pca_basis_source_modes=${PCA_BASIS_SOURCE_MODES:-all_variants}"
echo "[submit-delta-hier] pca_num_bands_values=${PCA_NUM_BANDS_VALUES:-1,2,4,8,16,32,64}"
...
echo "[submit-delta-hier] guided_restarts=${GUIDED_RESTARTS:-1}"
