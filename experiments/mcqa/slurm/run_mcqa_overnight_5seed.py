...
def main() -> None:
    ...
    manifest: dict[str, object] = {
        ...
        "stage_a_grid": {
            "transport_methods": str(args.stage_a_transport_methods),
    ...
    for seed in seeds:
        ...
        hierarchy_command = [
            sys.executable,
            "experiments/mcqa/mcqa_delta_hierarchical_sweep.py",
            "--device",
            str(args.device),
            "--model-name",
            str(args.model_name),
            ...
            str(args.stage_a_transport_methods),
        ...
        full_das_command = [
            sys.executable,
            "experiments/mcqa/mcqa_run_cloud.py",
            "--preset",
            "full",
            "--device",
            str(args.device),
        ...
        paper_runtime_command = [
            sys.executable,
            "experiments/mcqa/mcqa_paper_runtime.py",
            str(sweep_root),
            "--full-das-output",
