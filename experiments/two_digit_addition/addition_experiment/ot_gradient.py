...
from experiments.common.variable_width_mlp import VariableWidthMLPForClassification
...
def run_alignment_gradient_pipeline(
    ...
    if config.method == "gw":
        ...
        transport, transport_meta = solve_ot_transport(variable_signatures, site_signatures, ot_solver_config)
