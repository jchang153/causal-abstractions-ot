...
from experiments.common.variable_width_mlp import VariableWidthMLPForClassification, logits_from_output
    ...
    for index, spec in enumerate(specs, start=1):
        ...
        if config.verbose:
            ...
            print(
                ...
                f"| calibration_shared={calibration_metrics['mean_shared_digits']:.4f}"
            )
        if is_better:
            best_record = record
