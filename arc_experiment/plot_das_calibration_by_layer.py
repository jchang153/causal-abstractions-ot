"""Render a DAS calibration heatmap (layer x subspace_dim) from a saved ARC DAS JSON payload."""
...
INPUT_PATH = Path("results/4-9 arc gemma-2/20260409_144935_arc/arc_sig-whole_vocab_kl_t1_eps-1.json")
