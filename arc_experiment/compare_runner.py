"""Shared comparison runner for ARC OT/UOT/DAS experiments."""
...
class CompareExperimentConfig:
    """Config controlling one end-to-end ARC comparison run."""
...
def run_comparison(
    *,
    ...
    print_results_table(all_records, "ARC Counterfactual Test Results")
    print_results_table(summary_records, "ARC Method Average Summary")
